    ...
    <body>
      <div class="topnav">
          <div class="nav1" id="nav2">
            <ul>
              <li><a class="ggwp"  href="{{ url('/home') }}">RAR COMPANY</a></li>
              <li><a href="{{ url('list') }}">PRICE LIST</a></li>
              @if (Route::has('login'))
              ...
              <li style="float:right"><span class="glyphicon glyphicon-user"></span><a class="nav-right" href="{{ route('login') }}">LOGIN</a></li>
